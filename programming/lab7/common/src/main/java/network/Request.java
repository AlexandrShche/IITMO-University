...
public class Request implements Serializable {
    ...
    private OrdinaryWorker worker;
    private OrdinaryOrganization organization;
    ...
    public Request(Command command, Auth auth){
        ...
        if(command instanceof CommandWithArg){
            if(command instanceof CommandWithOrganizationArg){
                organization = (OrdinaryOrganization) ((CommandWithOrganizationArg) command).getOrganization();
            }
